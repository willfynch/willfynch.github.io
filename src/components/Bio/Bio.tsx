...
<p className='mb-4'>
    Thanks to my hard work, I was able to join <a className='link' rel='noopener' target='_blank' aria-label={lang === 'fr' ? 'Ouvrir dans un nouvel onglet' : 'Open in a new tab'} href='https://www.ecole-pmn.fr/'>La&nbsp;PMN</a>, <strong>La Passerelle des Métiers du Numérique</strong>, with an apprenticeship in a big digital services company where I met incredible people with whom I learnt a lot.
</p>
<p className="mb-4">
    Now working as a <strong>web developer</strong>, my job reminds me sometimes of what it was to play around with my old RPG Maker software. Except now my tool is code and I use more <a className='link' target='_blank' aria-label={lang === 'fr' ? 'Ouvrir dans un nouvel onglet' : 'Open in a new tab'} rel='noopener' href='https://stackoverflow.com/'>Stack&nbsp;Overflow</a> than <a className='link' target='_blank' aria-label={lang === 'fr' ? 'Ouvrir dans un nouvel onglet' : 'Open in a new tab'} rel='noopener' href='https://www.rpg-maker.fr/'>Oniromancie</a> !
</p>
<p className="mb-4">
...
<p className='mb-4'>
Grâce au travail fourni durant cette période, j'ai été accepté par <a className='link' rel='noopener' target='_blank' aria-label={lang === 'fr' ? 'Ouvrir dans un nouvel onglet' : 'Open in a new tab'} href='https://www.ecole-pmn.fr/'>La&nbsp;PMN</a>, <strong>La Passerelle des Métiers du Numérique</strong>, avec un contrat d'apprentissage au sein d'une grande ESN où j'ai rencontré d'incroyables personnes auprès desquelles j'ai beaucoup appris.
</p>
<p className="mb-4">
...
export default function Bio() {
    ...
    return (
        <section id='about' className={styles.bioSection + ` ` + `bg-my-white lg:py-32 px-10 sm:px-20 xl:px-72 lg:px-40 2xl:px-[40rem] py-20 sm:py-40`}>
                ...
                <div className='flex flex-row justify-center mt-8'>
                    <ul className='flex flex-row'>
                        ...
                        <li key={'elegance'} className='group mr-6 cursor-default shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] hover:shadow-[rgba(6,_24,_44,_0.6)_0px_0px_2px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] w-20 h-20 md:w-24 md:h-24 xl:w-40 xl:h-40 rounded-full flex justify-center items-center flex-col  transition-all'>
                            ...
                            <p className='duration-300 group-hover:scale-95 text-xs md:text-sm xl:text-xl text-slate-700'>{lang==='fr'?'Élégance':'Elegance'}</p>
                        </li>
                        <li key={'simplicity'} className='group mr-6 cursor-default shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] hover:shadow-[rgba(6,_24,_44,_0.6)_0px_0px_2px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] w-20 h-20 md:w-24 md:h-24 xl:w-40 xl:h-40 rounded-full flex justify-center items-center flex-col  transition-all'>
