...
export default function BlogPostCard(props: BlogPostCardProps) {
    ...
    return (
        <div className="text-base text-my-black duration-200 flex flex-col sm:flex-row hover:shadow-md group shadow-lg">
            ...
            <div className="sm:w-1/2 p-8 sm:p-8 bg-my-white flex flex-col justify-center">
                <Link className=" font-black hover:text-my-brown uppercase" href={`/blog/${props.slug}`}>{props.title}</Link>
