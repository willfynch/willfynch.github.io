...
-36 139 -10 251 112 493 93 184 100 215 68 270 -33 55 -98 78 -160 56z" className={styles.firstOne}>
</path>
{/** LEFT FUMEE */}
...
145 565 39 68 50 97 50 131 0 48 -26 101 -58 118 -34 18 -95 22 -127 7z" className={styles.firstTwo}></path>
{/** RIGHT FUMEE */}
...
-113 5z" className={styles.firstThree}></path>
