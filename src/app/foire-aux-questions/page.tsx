...
export default async function Faq() {
    ...
    return (
        <main>
            <Banner height="400" opacity={'70'} text={BANNER_TEXT} image={"/images/travel-yaroslav-shuraev.webp"} callToAction={{ path: 'https://www.instagram.com/willdevweb/', text: 'Envoie-moi un message' }} isCallToAction={true} />
