...
export default function ContactWidget() {
    ...
    return (
        <>
            {/**PC VIEW */}
            <a rel='noopener' href="https://calendly.com/fr" aria-label={lang === 'fr' ? 'Ouvre Calendly pour prendre RDV' : 'Open Calendly to book an appointment'} className={ " hidden sm:flex " + ' ' + "cursor-pointer rounded-md w-[80px] h-[80px]  bg-my-white hover:bg-my-black duration-300 z-40 group fixed right-4 bottom-4 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]"}>
