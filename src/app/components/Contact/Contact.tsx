            ...
            <div className={'mt-6 flex flex-col justify-center items-center gap-4' + ' '}>
...

                {
                    translatedSteps?.map(step => {
                        return (
                            <div id='STEP_COMPONENT' className=' w-full flex h-[160px] rounded-md xs:-rounded-md md:h-[130px] overflow-hidden'>
                                <div id='STEP_NUMBER' className={styles.number + ' ' + 'duration-300 hidden xs:flex justify-center items-center text-xl font-bold w-[120px] '} >
                                    {step.id}
                                </div>
                                <div id='STEP_DESCRIPTION' className={styles.description + ' ' + 'overflow-hidden relative w-full h-full text-white'}>
                                    ...
                                    <Image className={styles.description + ` z-0 duration-300 rounded-md object-cover`} fill src={`${step.image}`} alt="" />
                                </div>
                            </div>
                        )
                    })
