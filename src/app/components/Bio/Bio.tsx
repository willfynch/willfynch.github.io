...
export enum BIO_CONTENT {
    ...
    When I was a kid, I discovered the joys of <a rel='noopener' className='link' target='_blank' href='https://www.rpgmakerweb.com/downloads'>RPG&nbsp;Maker</a>, a software that helped you create your own
    adventure video-game. It was all about learning by yourself and searching the Internet for tips and tools, and even learning about <a rel='noopener' className='link' target='_blank' href='https://www.ruby-lang.org/fr/'>Ruby</a>, the first programming language I ever touched.
</p>
...
<p className='mb-4'>
    Thanks to my hard work, I was able to join <a className='link' rel='noopener' target='_blank' href='https://www.ecole-pmn.fr/'>La&nbsp;PMN</a>, <strong>La Passerelle des Métiers du Numérique</strong>, with an apprenticeship at <a rel='noopener' className='link' target='_blank' href='https://www.capgemini.com/fr-fr/'>Capgemini</a> where I met incredible people with whom I learnt a lot.
</p>
<p className="mb-4">
