    ...
    return (
        <section id='projects' className={styles.prjSection + ` ` + `bg-my-white relative py-16 lg:py-40 px-10 sm:px-20 xl:px-72 lg:px-40`}>
            ...
            <div className='relative h-[100px] py-20'>
                <h2 className='w-full text-center absolute font-bilbo text-x6demixl sm:text-x6demixl md:text-9xl top-1/2 -translate-y-1/2  text-my-black/10'>Projects</h2>
                <h2 className='w-full text-center absolute text-lg font-bold top-1/2 -translate-y-1/2 '>PROJECTS</h2>
            </div>
