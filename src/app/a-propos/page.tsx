...
export default function About() {
    return (
        <main className="text-normal text-my-black">
            ...
            <Banner alt={"Une tasse de cafée brandie à bout de bras au-dessus des montagnes, en face d'un soleil couchant."} height='400' opacity={'70'} isCallToAction={false} text={ABOUT_TEXTS.SECOND} image='/images/coffee-bianca-gasparoto.webp' ></Banner>
            ...
            <Banner alt={"Utilisateur d'ordinateur en train d'écrire"} height='400' opacity='70' isCallToAction={true} callToAction={{text: 'Foire Aux Questions', path: '/foire-aux-questions'}} text={ABOUT_TEXTS.FIFTH} image={'/images/user-matheus-bertelli.webp'}></Banner>
